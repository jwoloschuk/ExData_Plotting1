...
# plot2.R will download the Electircal Power Consumption dataset and will produce 
# a plot detailing Global Active Power (kilowatt) versus Time (day of the week).
...
# Create basic plot using plot(), change type to line, remove x axis label and 
